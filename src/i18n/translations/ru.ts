...
export const ru = {
  ...
  goals: {
    ...
    priorityModalTitle: "Система приоритета работы",
    priorityModal: {
      ...
      storage: "Хранилище: IndexedDB — данные не теряются при очистке кэша браузера.",
      autoUpdate:
        "Автообновление: пересчёт каждые 3 часа + принудительный сброс через консоль (-theme не считается).",
      decay: "Деградация: приоритет медленно растёт при отсутствии выполненных задач.",
      versioning: "Версионирование: алгоритм обновляется автоматически при изменении формулы.",
      i18n: "Локализация: полная поддержка RU/EN для проектов, задач и статистики.",
      updateNote:
        "Обновляется автоматически каждые 3 часа, при изменении целей или смене версии алгоритма.",
    },
    stats: {
