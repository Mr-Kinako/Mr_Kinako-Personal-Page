...
export const projectsEn: Record<string, ProjectTranslations> = {
   "web-osu-lazer-server": {
      ...
      tasks: {
         ...
         "101": {
            title: "Registration",
            description: "Country selection: List color and text color should be different, not the same.",
         },
         "102": {
   ...
   "mr-kinako-personal-page": {
      ...
      tasks: {
         ...
         "104": {
            ...
            description: 'The "/goals" route needs to be brought to a working state. Other fixes later.',
         },
      },
   },
